...
export 'package:quiz/quiz.dart';
export 'package:aqueduct/test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for quiz.
///
/// Use instances of this class to start/stop the test quiz server. Use [client] to execute
/// requests against the test server.  This instance will use configuration values
/// from config.src.yaml.
class TestApplication {
  Application<QuizSink> application;
  QuizSink get sink => application.mainIsolateSink;
  TestClient client;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [QuizSink]. Invoke this method
  ...
  Future start() async {
    ...
    await createDatabaseSchema(sink.context); // creates our db tables
